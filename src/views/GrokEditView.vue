<template>
  <div class="grok-container">
    <div class="page-header">
      <div>
        <h1 class="page-title">✏️ Grok 编辑图片</h1>
        <p class="page-subtitle">使用 Grok AI 编辑图片</p>
      </div>
    </div>
      ...
      <div class="form-section">
        <div class="form-group">
          <label class="form-label"
            >图片URL <span class="required">*</span></label
          >
          <el-input v-model="imageUrl" placeholder="输入图片URL地址" />
        </div>
